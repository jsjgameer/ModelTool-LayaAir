...
class FBXNode:
    ...
    def geometricTransform(self,pNode):
        ...
        self.addProp("position", [lTmpVector[0]*FBXUnit.GetGlobalFactio(), lTmpVector[1]*FBXUnit.GetGlobalFactio(), lTmpVector[2]*FBXUnit.GetGlobalFactio()])
        lTmpVector = pNode.LclRotation.Get()
        self.addProp("rotationEuler",[lTmpVector[0], lTmpVector[1], lTmpVector[2]])
    ...
    def analysisNodeContent(self, pNode):
        ...
        DisplayString("名字：", self.nodeName)
